...
contract SimpleArb {
    ...
    address public token = 0x89d24A6b4CcB1B6fAA2625fE562bDD9a23260359; // Sai - old version of DAI
    ...
    function arb() internal {
        ...
        Exchange2(exchange1).buyTokens.value(ethAmount)(token); // Buy Tokens Back
    }
